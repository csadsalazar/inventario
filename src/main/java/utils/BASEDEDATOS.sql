                            ...
                            DELIMITER //
                            CREATE PROCEDURE ListarBienesPorUsuario(IN usuarioId INT)
							BEGIN
								SELECT * FROM MA_Bienes WHERE FK_Usuario = usuarioId;
							
                            END
                            DELIMITER //
                            CREATE PROCEDURE ListarObservacionesPorBien(IN bienId BIGINT)
							BEGIN
								SELECT * FROM PA_BienesPorUsuario WHERE FK_Bien = bienId;
							END 
