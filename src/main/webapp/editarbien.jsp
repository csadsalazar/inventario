            ...
            <table id="agregarbien" class="table">
                ...
                <tbody>
                 <tr>
                    ...
                    <td data-label="Información"><input type="text" name="codigo" class="informacion" placeholder="Código" readonly value="<%= (bien != null) ? bien.getCodigo() : "" %>"></td>
                    </tr>
                    <tr>
                        <td data-label="Item">Placa:</td>
                        <td data-label="Información"><input type="text" name="placa" class="informacion" placeholder="Placa" readonly value="<%= (bien != null) ? bien.getPlaca() : "" %>"></td>
                    </tr>
